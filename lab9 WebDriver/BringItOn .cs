...
public class BringItOn : TestsClass
{
    ...
    public void Test1()
    {
        ...
        var nameText = findElement("//h1").Text; //equals with nameValue
        var codeText = findElement("//ol").Text;
        var selectedFormat = findElement("//a[@class='btn -small h_800']").Text;


        Assert.IsTrue(title == nameValue && codeText.Contains(codeValue) && selectedFormat == "Bash");
