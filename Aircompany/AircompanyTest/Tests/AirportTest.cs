...
namespace AircompanyTests.Tests
{
    ...
    public class AirportTest
    {
        ...
        [Test]
        public void MyTest1() //Test metod GetTransportMilitaryPlanes
        {
            Airport airport = new Airport(planes);
            List<MilitaryPlane> transportMilitaryPlanes = airport.GetTransportMilitaryPlanes();

            Assert.IsTrue(IsTransportList(transportMilitaryPlanes));
        }

        private bool IsTransportList(List<MilitaryPlane> transportMilitaryPlanes)
        {
        ...
        [Test]
        public void MyTest2() //Test metod GetPassengerPlaneWithMaxPassengersCapacity
        {
            Airport airport = new Airport(planes);
        ...
        [Test]
        public void MyTest3() //Test metod SortByMaxLoadCapacity
        {
            Airport airport = new Airport(planes);
            airport = airport.SortByMaxLoadCapacity();
            var planesSortedByMaxLoadCapacity = airport.GetAllPlanes().ToArray();
            ...
            Assert.IsTrue(IsSortedByMaxLoadCapacity(planesSortedByMaxLoadCapacity));
        }
        private bool IsSortedByMaxLoadCapacity(Plane[] planesSortedByMaxLoadCapacity)
        {
            for (int i = 0; i < planesSortedByMaxLoadCapacity.Length - 1; i++) {
