...
namespace Aircompany
{
    public class Runner
    {
        ...
        public static void Main(string[] args)
        {
            ...
            //PassengerPlane plane1 = new PassengerPlane("model", 10, 100, 100,100);
            //PassengerPlane plane2 = new PassengerPlane("model", 10, 100, 100, 100);

            //Console.WriteLine(plane1.Equals(plane2));
            Console.WriteLine(airport.GetPassengerPlaneWithMaxPassengersCapacity);
            Console.Read();
